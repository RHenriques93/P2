...
$dados = $db->query("SELECT DISTINCT utilizador.imagem, utilizador.nome, utilizador.id_utilizador, requisicao.nome_projeto, requisicao.descricao, requisicao.preco, requisicao.id_requisicao, requisicao.img_req FROM utilizador JOIN requisicao ON utilizador.id_utilizador = requisicao.id_utilizador JOIN subarea ON requisicao.id_subarea = subarea.id_subarea JOIN area ON subarea.id_area = area.id_area");

foreach ($dados as $row) {

                echo '<div class="col-md-4 col-sm-6 col-xs-12 mb-4">
                    <div class="card" >
                        <img src="'.$row["img_req"].'" class="card-img-top" alt="...">
                        <div class="card-body">
